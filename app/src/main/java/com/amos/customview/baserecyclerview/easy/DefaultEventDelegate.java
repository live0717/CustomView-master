...
public class DefaultEventDelegate implements EventDelegate {
    ...
    private BaseRvAdapter.OnMoreListener onMoreListener;
    private BaseRvAdapter.OnNoMoreListener onNoMoreListener;
    private BaseRvAdapter.OnErrorListener onErrorListener;
    ...
    public DefaultEventDelegate(BaseRvAdapter adapter) {
    ...
    @Override
    public void setMore(View view, BaseRvAdapter.OnMoreListener listener) {
    ...
    @Override
    public void setNoMore(View view, BaseRvAdapter.OnNoMoreListener listener) {
    ...
    @Override
    public void setErrorMore(View view, BaseRvAdapter.OnErrorListener listener) {
    ...
    @Override
    public void setMore(int res, BaseRvAdapter.OnMoreListener listener) {
    ...
    @Override
    public void setNoMore(int res, BaseRvAdapter.OnNoMoreListener listener) {
    ...
    @Override
    public void setErrorMore(int res, BaseRvAdapter.OnErrorListener listener) {
    ...
    private class EventFooter implements BaseRvAdapter.ItemView {
